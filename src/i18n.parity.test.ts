...
describe('i18n locale parity', () => {
  ...
  const IDENTICAL_TO_ENGLISH_ALLOWLIST: Record<string, string[]> = {
    ...
    'zh-CN': [],
    'zh-TW': [],
    de: ['aria.navigation', 'label.approval.block', 'label.approval.windowEta', 'label.common.navigation', 'label.composer.emoji', 'label.group.admin', 'label.group.global', 'label.member.online', 'nav.chat', 'label.composer.code'],
    el: ['app.title', 'label.composer.emoji'],
    es: ['label.approval.eta.hours', 'label.approval.eta.minutes', 'label.composer.emoji', 'label.error', 'label.group.global', 'message.error', 'nav.chat'],
    ...
    fr: ['aria.navigation', 'button.mention', 'label.approval.eta.hours', 'label.approval.eta.minutes', 'label.approval.signature', 'label.approval.type.unknown', 'label.common.direct', 'label.common.message', 'label.common.navigation', 'label.group.admin', 'label.group.global', 'label.invites', 'label.message', 'placeholder.message', 'title.directPanel', 'label.composer.code'],
    hi: ['app.title'],
    hu: ['label.composer.emoji', 'label.group.admin'],
    it: ['label.approval.eta.hours', 'label.approval.eta.minutes', 'label.composer.emoji', 'label.group.admin', 'label.member.online', 'nav.chat'],
    nb: ['app.title', 'button.send', 'button.startMinting', 'group.status.minting.minting', 'label.approval.eta.minutes', 'label.composer.emoji', 'label.group.admin', 'label.group.global', 'nav.chat'],
    nl: ['label.approval.eta.minutes', 'label.common.direct', 'label.composer.emoji', 'label.group.open', 'label.member.online', 'nav.chat', 'title.directPanel', 'label.composer.code'],
