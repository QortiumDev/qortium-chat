...
describe('i18n locale parity', () => {
  ...
  const IDENTICAL_TO_ENGLISH_ALLOWLIST: Record<string, string[]> = {
    ...
    'zh-CN': [],
    'zh-TW': [],
    de: ['aria.navigation', 'label.approval.block', 'label.approval.windowEta', 'label.common.navigation', 'label.composer.emoji', 'label.group.admin', 'label.group.global', 'label.member.online', 'nav.chat'],
    ...
    nl: ['label.approval.eta.minutes', 'label.common.direct', 'label.composer.emoji', 'label.group.open', 'label.member.online', 'nav.chat', 'title.directPanel'],
